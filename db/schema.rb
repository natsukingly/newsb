...
ActiveRecord::Schema.define(version: 20180301185149) do
  ...
  create_table "articles", force: :cascade do |t|
    ...
    t.string "keywords"
    t.text "description"
    t.boolean "category_lock", default: false
    t.integer "priority_level", default: 10
  end
  ...
  create_table "posts", force: :cascade do |t|
    ...
    t.string "tagged_user_ids", default: [], array: true
  end
  ...
  create_table "twitter_bot_logs", force: :cascade do |t|
    t.integer "article_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  end
